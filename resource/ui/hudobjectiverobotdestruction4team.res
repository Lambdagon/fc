...
{	
	...
	"ScoreContainer"
	{
		...
		"ProgressBarContainer"
		{
			...
			"GreenVictoryContainer"
			{
				"fieldName"				"GreenVictoryContainer"
				"ControlName"			"EditablePanel"
				"xpos"					"25"
				"ypos"					"22"
				"zpos"					"5"
			...
			"GreenProgressBarFill"
			{
				"fieldName"				"GreenProgressBarFill"
				"ControlName"			"ImagePanel"
				"xpos"					"0"
				"ypos"					"0"
				"zpos"					"2"
				...
				"proportionalToParent"	"1"
				"positionImage"			"0"
				"drawcolor"				"84 127 111 255"
				"Image"					"../hud/objectives_corepanel_meter_solid"

				"left_offset"			"10"
				"right_offset"			"0"
				"standard_color"		"84  127 111 255"
				"bright_color"			"110 189 159 255"
				"left_to_right"			"0"
				"blink_threshold"		"1.0"
				"blink_rate"			"10"
			}

			"GreenProgressBarEscrow"
			{
				"fieldName"				"GreenProgressBarEscrow"
				"ControlName"			"ImagePanel"
				"xpos"					"0"
				"ypos"					"0"
				"zpos"					"1"
				...
				"left_offset"			"10"
				"right_offset"			"0"
				"standard_color"		"127 152 143 255"
				"bright_color"			"177 202 193 255"
				"left_to_right"			"0"
				"blink_threshold"		"1"
				"blink_rate"			"20"
			}
			
			"YellowVictoryContainer"
			{
				"fieldName"				"YellowVictoryContainer"
				"ControlName"			"EditablePanel"
				"xpos"					"25"
				"ypos"					"22"
				"zpos"					"5"
			...
			{
				"fieldName"				"YellowProgressBarFill"
				"ControlName"			"ImagePanel"
				"xpos"					"0"
				"ypos"					"0"
				"zpos"					"2"
				...
				"left_offset"			"10"
				"right_offset"			"0"
				"standard_color"		"127 127 84 255"
				"bright_color"			"189 189 110 255"
				"left_to_right"			"0"
				"blink_threshold"		"1.0"
				"blink_rate"			"10"
			}

			"YellowProgressBarEscrow"
			{
				"fieldName"				"YellowProgressBarEscrow"
				"ControlName"			"ImagePanel"
				"xpos"					"0"
				"ypos"					"0"
				"zpos"					"1"
				...
				"left_offset"			"10"
				"right_offset"			"0"
				"standard_color"		"152 152 127 255"
				"bright_color"			"203 203 177 255"
				"left_to_right"			"0"
				"blink_threshold"		"1"
				"blink_rate"			"20"
			}
		...
		"GreenScoreValueContainer"
		{
			"ControlName"		"EditablePanel"
			"fieldName"			"GreenScoreValueContainer"
			"xpos"				"80"
			"ypos"				"r48"
			"zpos"				"10"
			"wide"				"60"
		...
		"YellowScoreValueContainer"
		{
			"ControlName"		"EditablePanel"
			"fieldName"			"YellowScoreValueContainer"
			"xpos"				"r140"
			"ypos"				"r48"
			"zpos"				"10"
			"wide"				"60"
		...
		"GreenStolenContainer"
		{
			"ControlName"		"EditablePanel"
			"fieldName"			"GreenStolenContainer"
			"xpos"				"r45"
			"ypos"				"r77"
			"zpos"				"1"
			"wide"				"30"
		...
		"YellowStolenContainer"
		{
			"ControlName"		"EditablePanel"
			"fieldName"			"YellowStolenContainer"
			"xpos"				"r45"
			"ypos"				"r77"
			"zpos"				"1"
			"wide"				"30"
